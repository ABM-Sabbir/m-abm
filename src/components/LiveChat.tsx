  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 p-4 bg-amber-600 text-white rounded-full shadow-xl hover:bg-amber-700 transition-all z-50 flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 ${isOpen ? 'scale-0 opacity-0 pointer-events-none' : 'scale-100 opacity-100'}`}
            ...
            <div className="bg-amber-50 border-b border-amber-100 p-3 flex items-center justify-between shrink-0">
              ...
              <div className="flex gap-2">
                <a 
                  ...
                  className="flex items-center gap-1.5 bg-amber-600 text-white px-3 py-1.5 rounded-full text-xs font-medium hover:bg-amber-700 transition-colors shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-amber-50"
                >
                ...
                <a 
                  href="#contact" 
                  onClick={() => setIsOpen(false)}
                  className="flex items-center gap-1.5 bg-white text-amber-700 border border-amber-200 px-3 py-1.5 rounded-full text-xs font-medium hover:bg-amber-50 transition-colors shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-amber-50"
                >
            ...
            <div className="p-4 bg-white border-t border-slate-100">
              <form onSubmit={handleSend} className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-full text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 transition-all disabled:opacity-50"
                />
                <button
                  type="submit"
                  disabled={!inputValue.trim() || isLoading}
                  className="p-2.5 bg-amber-600 text-white rounded-full hover:bg-amber-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2"
